...
switch figure_choice
    case 1
        ...
        legend([h1(1) h2(1) h3(1)],['150%, area=' num2str(ROCarea1{1,1}*100,'%3.1f') '%'],...
            ['100%, area=' num2str(ROCarea1{2,1}*100,'%3.1f') '%'],...
    ...
    case 3
        ...
        legend([h1(1) h2(1) h3(1)],['(4,-4), area=' num2str(ROCarea2{1,1}*100,'%3.1f') '%'],...
