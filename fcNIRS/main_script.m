...
subj{2} = 'epi102FA';
subj{3} = 'epi103GJ';
subj{4} = 'epi104MAL'; % Le cas 104MAL est extrêmement inhabituel. (M)
subj{5} = 'epi105MER';
subj{6} = 'epi106VLL';
subj{7} = 'epi107GC';
subj{8} = 'epi108DD';
...
subj{15} = 'epi115MD';
subj{16} = 'epi116GA';
subj{17} = 'epi117FDH'; % excluded because fNIRS optodes were not covering the epileptic focus due to technical problems (M)
subj{18} = 'epi118MC';
subj{19} = 'epi119MG';  % only 1 IED was captured during a 15-min recording (M)
subj{21} = 'epi121FB';
subj{22} = 'epi122PEV'; % excluded as very few IEDs were detected on EEG recordings (M)
subj{23} = 'epi123JR';
subj{24} = 'epi124YP';
subj{25} = 'epi125YD';
subj{26} = 'epi126AB';
...
subj{32} = 'epi132FG';
subj{33} = 'epi133EA';
subj{34} = 'epi134ASC'; % excluded as very few IEDs were detected on EEG recordings (F)
subj{35} = 'epi135MHT';
subj{36} = 'epi136JSL';
subj{37} = 'epi137SR'; % excluded because focus localization was clinically uncertain despite extensive multi-modal evaluation (M)
subj{38} = 'epi138BG';
subj{39} = 'epi139JB';
subj{40} = 'epi140GG';
subj{41} = 'epi141JP';
...
%2) Subjects to run
OP.subjects = [1:19 21:49]; %49; %[49 47 46 42 4]; %[ 48];
