...
%Draw
nirs_orthviews_fcNIRS('Reset');
h = nirs_orthviews_fcNIRS('Image', render, [0.05 0.05 0.9 0.7]);
nirs_orthviews_fcNIRS('AddContext', h);
nirs_orthviews_fcNIRS('MaxBB');
%if ~isempty(hReg), spm_orthviews('Register', hReg); end
nirs_orthviews_fcNIRS('AddBlobs', h, xSPM.XYZ, xSPM.Z, xSPM.M);
nirs_orthviews_fcNIRS('Redraw');
