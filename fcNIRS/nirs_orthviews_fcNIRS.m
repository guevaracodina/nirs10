function varargout = nirs_orthviews_fcNIRS(action,varargin)
% This function origins from spm_orthviews
% NIRS version created for nirs10 toolbox
% change split colormap to better reflect clusters //EGC
%
        ...
        if isfield(st.vols{i},'blobs'),
            if ~isfield(st.vols{i}.blobs{1},'colour'),
                ...
                % if size(cmap,1)~=128
                    ...
                    spm_figure('Colormap','gray-jet') % Visualize clusters //EGC
                % end;
