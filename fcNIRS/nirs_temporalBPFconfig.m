function [z, p, k] = nirs_temporalBPFconfig(type, fs, cutoff, FilterOrder, varargin)
% Butterworth type Band-pass filter (1-D)
% SYNTAX
% [z, p, k] = nirs_temporalBPFconfig(type, fs, cutoff, FilterOrder, [Rp Rs])
% INPUTS
...
try
    ...
    if numVarArgs > 1
        error('nirs10:nirs_temporalBPFconfig:TooManyInputs', ...
