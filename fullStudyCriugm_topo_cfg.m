...
matlabbatch{2}.spm.tools.nirs10.preprocANAT.MCsegment1.NIRSmat(1).tname = 'NIRS.mat';
...
matlabbatch{2}.spm.tools.nirs10.preprocANAT.MCsegment1.NIRSmat(1).sname = 'Read and format CRIUGM data: NIRS.mat';
...
matlabbatch{3}.spm.tools.nirs10.preprocessNIRS.normalize_baseline.NIRSmatCopyChoice.NIRSmatOverwrite = struct([]);
...
matlabbatch{4}.spm.tools.nirs10.preprocessNIRS.ODtoHbOHbR.NIRSmatCopyChoice.NIRSmatOverwrite = struct([]);
...
matlabbatch{5}.spm.tools.nirs10.coregNIRS.coreg1.NIRSmatCopyChoice.NIRSmatOverwrite = struct([]);
