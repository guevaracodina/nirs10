...
% ------------------------------------------------------------------------------
% functional connectivity NIRS (fcNIRS) menus //EGC
% For all the h13a* items see nirs_fcNIRS_cfg.m //EGC
% ------------------------------------------------------------------------------
h13a = uimenu(h0,...
    'Label',            'fcNIRS',...
    'Separator',        'on',...
    ...
    'HandleVisibility', 'on');
h13a1 = uimenu(h13a,...
    'Label',            'Create ROI in channel space',...
    'Separator',        'off',...
    'Tag',              'createROI',...
    'CallBack',         'spm_jobman(''interactive'','''',''spm.tools.nirs10.fcNIRS.create_roi1'');',...
    'HandleVisibility', 'on');
h13a2 = uimenu(h13a,...
    'Label',            'Extract ROI in channel space',...
    'Separator',        'off',...
    'Tag',              'extractROI',...
    'CallBack',         'spm_jobman(''interactive'','''',''spm.tools.nirs10.fcNIRS.extract_roi1'');',...
    'HandleVisibility', 'on');
h13a3 = uimenu(h13a,...
    'Label',            'BPF & Downsampling',...
    'Separator',        'off',...
    'Tag',              'BPF_N_downSample',...
    'CallBack',         'spm_jobman(''interactive'','''',''spm.tools.nirs10.fcNIRS.filtdown1'');',...
    'HandleVisibility', 'on');
h13a4 = uimenu(h13a,...
    'Label',            'GLM regression of global brain signal',...
    'Separator',        'off',...
    'Tag',              'GLM_regress_global',...
    'CallBack',         'spm_jobman(''interactive'','''',''spm.tools.nirs10.fcNIRS.fc_GLM_on_ROI1'');',...
    'HandleVisibility', 'on');
h13a5 = uimenu(h13a,...
    'Label',            'fcNIRS Orthogonal Coregistration',...
    'Separator',        'off',...
    'Tag',              'fcNIRS_OrthCoreg',...
    'CallBack',         'spm_jobman(''interactive'','''',''spm.tools.nirs10.fcNIRS.fcNIRS_OrthCoreg'');',...
    'HandleVisibility', 'on');
h13a6 = uimenu(h13a,...
    'Label',            'Send e-mail',...
    'Separator',        'off',...
...
h165 = uimenu(h16,...
	'Label',	'Combine Tmaps',...
	'Separator',	'off',...
	'Tag',		'Combine one or more Tmaps',...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.nirs10.nirs_utilities.liom_ctmap'');',...
	'HandleVisibility','on');
h166 = uimenu(h16,...
	'Label',	'Time Point HRF estimation',...
	'Separator',	'off',...
	'Tag',		'Estimate time point HRF',...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.nirs10.nirs_utilities.liom_tpHRF'');',...
	'HandleVisibility','on');
h17  = uimenu(h0,...
