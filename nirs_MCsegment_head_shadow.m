...
[dummy,V] = spm_imcalc_ui([strcat(dir,filesep,'c1',name,'.nii');...
    strcat(dir,filesep,'c2',name,'.nii');...
    strcat(dir,filesep,'c3',name,'.nii');...
    strcat(dir,filesep,'c4',name,'.nii');...
    strcat(dir,filesep,'c5',name,'.nii')],...
    strcat(dir,filesep,'head_shadow_ci.nii'),...
    'i1+i2+i3+i4+i5');
...
varargout{1} = strcat(dir,filesep,'processed_head_shadow_ci','.nii');