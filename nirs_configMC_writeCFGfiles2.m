...
%                     opt_ppts{iwl,5});
%                 fprintf(fid, 'tissue { mua = %5.4f mus = %3.2f g = %2.1f n = %3.2f } ; 6 = sinuses \n',...
%                     opt_ppts{iwl,6});
...
%                     opt_ppts{iwl,5});
%                 fprintf(fid, 'tissue { mua = %5.4f mus = %3.2f g = %2.1f n = %3.2f } ; 12 = sinuses and bold response \n',...
%                     opt_ppts{iwl,6}); 
                end
            ...
            elseif algo==1 % MCX
                ...
                fprintf(fid, '%3.2f %2.1f %5.4f %3.2f %s\n', ...
                    scalings.*squeeze(opt_ppts(iwl,1,[2 3 1 4]))','# GM: scat(1/mm), g, mua (1/mm), n');
                fprintf(fid, '%3.2f %2.1f %5.4f %3.2f %s\n', ...
                    scalings.*squeeze(opt_ppts(iwl,2,[2 3 1 4]))','# WM: scat(1/mm), g, mua (1/mm), n');
                fprintf(fid, '%3.2f %2.1f %5.4f %3.2f %s\n', ...
                    scalings.*squeeze(opt_ppts(iwl,3,[2 3 1 4]))','# CSF: scat(1/mm), g, mua (1/mm), n');
                fprintf(fid, '%3.2f %2.1f %5.4f %3.2f %s\n', ...
                    scalings.*squeeze(opt_ppts(iwl,4,[2 3 1 4]))','# Skull: scat(1/mm), g, mua (1/mm), n');
                fprintf(fid, '%3.2f %2.1f %5.4f %3.2f %s\n', ...
                    scalings.*squeeze(opt_ppts(iwl,5,[2 3 1 4]))','# Scalp: scat(1/mm), g, mua (1/mm), n');
                fprintf(fid, '%3.2f %2.1f %5.4f %3.2f %s\n', ...
                    scalings.*squeeze(opt_ppts(iwl,6,[2 3 1 4]))','# Sinuses: scat(1/mm), g, mua (1/mm), n');
%                 fprintf(fid, '%3.2f %2.1f %5.4f %3.2f %s\n', ...
%                     opt_ppts_perturb{iwl}([2 3 1 4]),'# Perturbation: scat(1/mm), g, mua (1/mm), n');
                if pve_cfg==1
                        fprintf(fid, '%3.2f %2.1f %5.4f %3.2f %s\n', ...
                    scalings.*squeeze(opt_ppts(iwl,1,[2 3 1 4]))','# GM (BOLD): scat(1/mm), g, mua (1/mm), n');
                fprintf(fid, '%3.2f %2.1f %5.4f %3.2f %s\n', ...
                    scalings.*squeeze(opt_ppts(iwl,2,[2 3 1 4]))','# WM (BOLD): scat(1/mm), g, mua (1/mm), n');
                fprintf(fid, '%3.2f %2.1f %5.4f %3.2f %s\n', ...
                    scalings.*squeeze(opt_ppts(iwl,3,[2 3 1 4]))','# CSF (BOLD): scat(1/mm), g, mua (1/mm), n');
                fprintf(fid, '%3.2f %2.1f %5f %3.2f %s\n', ...
                    scalings.*squeeze(opt_ppts(iwl,4,[2 3 1 4]))','# Skull (BOLD): scat(1/mm), g, mua (1/mm), n');
                fprintf(fid, '%3.2f %2.1f %5.4f %3.2f %s\n', ...
                    scalings.*squeeze(opt_ppts(iwl,5,[2 3 1 4]))','# Scalp (BOLD): scat(1/mm), g, mua (1/mm), n');
                fprintf(fid, '%3.2f %2.1f %5.4f %3.2f %s\n', ...
                    scalings.*squeeze(opt_ppts(iwl,6,[2 3 1 4]))','# Sinuses (BOLD): scat(1/mm), g, mua (1/mm), n');
                end
