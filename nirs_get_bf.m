...
switch xBF.name
    ...
    otherwise
        ...
        if isfield(xBF,'name0') && strcmp(xBF.name0,'eHRF')
            [bf p]         = nirs_ehrf(dt);
            ...
            % canonical hemodynamic response function -- or epileptic HRF
            %----------------------------------------------------------------------
            [bf p]         = spm_hrf(dt);
