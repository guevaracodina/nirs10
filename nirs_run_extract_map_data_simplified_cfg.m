function extract_map_data_simplified = nirs_run_extract_map_data_simplified_cfg
...
% Executable Branch
extract_map_data_simplified      = cfg_exbranch;
extract_map_data_simplified.name = 'Extract map data -- Simplified';
extract_map_data_simplified.tag  = 'extract_map_data_simplified';
extract_map_data_simplified.val  = {NIRSmat extract_TOPO_map extract_TOPO_con ...
    view extract_base_contrast ...
    extract_contrast extract_select_mode ...
    extract_average_mode extract_struct_name};
extract_map_data_simplified.prog = @nirs_run_extract_map_data;
extract_map_data_simplified.vout = @nirs_cfg_vout_extract_map_data;
extract_map_data_simplified.help = {'Extract_map_data.'};
