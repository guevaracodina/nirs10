function tikhonov1 = nirs_run_inverse_tikhonov_cfg
[NIRSmat redo1 NIRSmatCopyChoice] = get_common_NIRSmat(1,'tikh');
...
tikhonov1.val  = {NIRSmat redo1 NIRSmatCopyChoice psel_choice dir_in sens_vxsize tikh_method alpha spatial_constraint};
