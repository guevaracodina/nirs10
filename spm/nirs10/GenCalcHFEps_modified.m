function [EpsHF EpsList EpsGG]=GenCalcHFEps_modified(Y,BTFacs,WInFacs,S)
...
if nargin<4 || isempty(S)
    ...
    N=length(unique(S))/prod(BT.nTreats);   %divide the num of unique subjects by the num of BT subj treatments to get the N for each ind. cell
end
