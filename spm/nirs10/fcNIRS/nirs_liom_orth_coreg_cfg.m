function fcNIRS_OrthCoreg = nirs_liom_orth_coreg_cfg
%Configuration file for nirs_liom_orth_coreg_run function
%Ke Peng, 
%2013-07-25, version 0.1, 
% Project channels colors according to clusters //EGC
...
% Always force redo to avoid error
redo1.val{1}                = 1;
...
fcNIRS_OrthCoreg            = cfg_exbranch;
fcNIRS_OrthCoreg.name       = 'fcNIRS Orthogonal Coregistration';
fcNIRS_OrthCoreg.tag        = 'fcNIRS_OrthCoreg';
fcNIRS_OrthCoreg.val        = {NIRSmat redo1 NIRSmatCopyChoice render_image Coreg_type Coreg_layer radius_channel};
fcNIRS_OrthCoreg.prog       = @nirs_liom_orth_coreg_run;
fcNIRS_OrthCoreg.vout       = @nirs_cfg_vout_liom_orth_coreg;
fcNIRS_OrthCoreg.help       = {'This module can now be run by itself or as part of a larger batch.'}';
