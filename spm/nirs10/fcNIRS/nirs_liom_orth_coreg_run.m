function out = nirs_liom_orth_coreg_run(job)
%==========================================================================
...
for Idx=1:size(job.NIRSmat,1)
    ...
    try
        ...
        if ~isempty(NIRS) && (~isfield(NIRS.flags,'OrthCoreg_OK') || job.force_redo)
            ...
            %% Coregistration
            [coreg xSPM opt] = nirs_orthPrep_fcNIRS(coreg,opsel,opt_info.render_template,coreg_layer,m2v,dataNIRS);
            ...
            nirs_orthdraw_fcNIRS(xSPM, file_render);
