...
h41 = uimenu(h4,...
	...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.nirs10.preprocessNIRS.paces1'');',...
	'HandleVisibility','on');
h42 = uimenu(h4,...
...
h9  = uimenu(h0,...
    ...
    'HandleVisibility','on');
h91  = uimenu(h9,...
    'Label',	'LIOM GLM Model Specification (WLS and BGLM)',...
    'Separator',	'off',...
    'Tag',		'LIOM GLM Model Specification (WLS and BGLM)',...
...
h10  = uimenu(h0,...
    ...
    'HandleVisibility','on');
h101  = uimenu(h10,...
    'Label',	'LIOM GLM Estimation (WLS and BGLM)',...
    'Separator',	'off',...
    'Tag',		'LIOM GLM Estimation (WLS and BGLM)',...
