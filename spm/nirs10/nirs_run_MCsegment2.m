...
%         try
            ...
            %%% on trqite lq couche de peau qui est la plus delicate
            ...
            if ~spm_existfile(fullfile(dir,filesep,'belongs2n_ci.nii'))
                [dummy,Vb] = spm_imcalc_ui([strcat(dir,filesep,'c1',name,'.nii');...
                    strcat(dir,filesep,'c2',name,'.nii');...
                    strcat(dir,filesep,'c3',name,'.nii');...
                    strcat(dir,filesep,'c4',name,'.nii');...
                    strcat(dir,filesep,'processed_c5',name,'.nii')],...
                    strcat(dir,filesep,'belongs2n_ci.nii'),...
                    'i1+i2+i3+i4+i5');
            ...
            jobr.Y1 = fullfile(dir,['c1',name,'.nii']);
            jobr.Y2 = fullfile(dir,['c2',name,'.nii']);
            jobr.Y3 = fullfile(dir,['c3',name,'.nii']);
            jobr.Y4 = fullfile(dir,['c4',name,'.nii']);
            jobr.Y5 = fullfile(dir,['c5',name,'.nii']);
