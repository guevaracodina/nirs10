        ...
        switch cs.alg
            ...
            case 2 %tMCimg
                ...
                for k1=1:size(t,1)
                    ...
                    Name = {'HbO','Hb'};
                    Conc = [60micro HbO 40microHbR];
                    
                    [mua] = GetMua(tk_wl);
                    muas = [cs.par.gmPpties_l1(),cs.par.wmPpties_l1(),cs.par.csfPpties_l1(),cs.par.skullPpties_l1(),cs.par.scalpPpties_l1(),cs.par.perturbationPpties_l1()];
                    
                    [allhistory nbPhotonsTotSimu ntissus muaEachTiss] = lirehis_clm(t(k1,:),cs.par.nphotons,cs.NDkpt,ntissues,cs.par.numTimeGates);
                ...
                %%%%%% LQMBDA NO USE \\\\\ end     % Libérer mémoire
                %clear allhistory
