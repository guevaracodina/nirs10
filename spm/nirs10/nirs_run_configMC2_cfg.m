...
[NIRSmat redo1 NIRSmatCopyChoice] = get_common_NIRSmat(1,'cfgMC');
...
configMC1.val  = {NIRSmat redo1 NIRSmatCopyChoice MC_nam mcim_cfg ...
    MC_CUDAchoice dpf_cfg pve_cfg MC_configdir mu_subj MC_parameters};
