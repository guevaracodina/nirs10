function coreg2 = nirs_run_coreg_2templateT1_cfg
[NIRSmat redo1 NIRSmatCopyChoice] = get_common_NIRSmat(1,'coreg2T');
...
coreg2.tag  = 'coreg2';
coreg2.val  = {NIRSmat redo1 NIRSmatCopyChoice anatT1 segT1_4fit ...
