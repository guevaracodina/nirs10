...
acquisition      = cfg_branch;
acquisition.tag  = 'acquisition';
acquisition.name = 'Acquisition';
acquisition.val  = {nirs_file CWsystem};
acquisition.help = {'Acquisition'};

gen_acquisition         = cfg_repeat;
gen_acquisition.tag     = 'gen_acquisition';
gen_acquisition.name    = 'Acquisitions';
gen_acquisition.help    = {'Help'};
gen_acquisition.values  = {acquisition};
gen_acquisition.num     = [1 Inf];
...
preprocANAT.values = {MCsegment1 buildroi1}; 
