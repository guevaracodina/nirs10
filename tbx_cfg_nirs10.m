...
coregNIRS.values = {nirs_run_coreg_cfg nirs_run_coreg_new_cfg nirs_run_coreg_2templateT1_cfg ...
...
model_specify.name   = 'GLM Specification (or Averaging/CINE)';
model_specify.tag    = 'model_specify';
model_specify.values = {nirs_run_liom_intrasubject_average_cfg ...
                        nirs_run_liom_GLM_specify_cfg nirs_run_liom_cine_cfg};
...
model_estimate.values = {nirs_run_liom_GLM_estimate_cfg nirs_run_liom_contrast_cfg  ...
    nirs_run_liom_group_cfg nirs_run_extract_map_data_cfg nirs_run_extract_map_data_simplified_cfg ...
    nirs_run_liom_1way_anova_cfg ...
...
nirs_utilities.values = {nirs_run_nii_to_2D_cfg nirs_run_liom_focus_projection_cfg nirs_run_liom_sensitivity_specificity_cfg nirs_run_liom_orth_coreg_cfg nirs_run_combine_tmap_cfg nirs_run_liom_tpHRF_cfg};
