...
nirs_utilities.values = {nirs_run_nii_to_2D_cfg nirs_run_liom_focus_projection_cfg nirs_run_liom_sensitivity_specificity_cfg nirs_run_liom_orth_coreg_cfg};
